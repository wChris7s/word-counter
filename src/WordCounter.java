...
public class WordCounter {
  ...
  private static final ConcurrentMap<String, LongAdder> wordCounts = new ConcurrentHashMap<>();
  ...
  public static void main(String[] args) {
    ...
    File file = new File(String.format("files/word-counter-files/random_%dGB.txt", GB_SIZE));
